...
const [file,setfile]=useState("");
    ...
    return(
        ...
        <div className="xyz">
        <Navbar1/>
        <h2 style={{textAlign : 'center',marginTop :'30px'}}>Register Yourself Here</h2>
    ...
    <div className="mx-auto actualform p-2 rounded-bottom" >
        ...
        <div className="form-group row mb-1">
            <label htmlFor="password" className="col-sm-3 col-form-label">Confirm Password:</label>
            <div className="col-sm-9">
                <input type="text" className="form-control" id="password" placeholder="Enter your Password" onChange={(e)=>setName(e.target.value)}/>
            </div>
        </div>
        ...
        <div className="col-sm-12 text-center mt-3">
                <button type="submit" className="btn btn-primary"  onClick={Save1}><Link to="/Initial_login" className="ml-2 text-decoration-none">Register</Link></button>
            </div>
        </div>
...
}export default Initisal_Register;